...
const App: React.FC = () => {
  ...
  return (
    <div className="App">
      ...
      I made this terminal looking portfolio from scratch for fun using React, Typescript and a bit of CSS<br/>
...
<TerminalCommand lastCommand={false} timeout={12000} text={' history | grep "roland" '} output={
<Fragment>
...
<TerminalCommand lastCommand={false} timeout={14000} text={' cat rolandHistory.txt '} output={
<Fragment>
...
<TerminalCommand lastCommand={false} timeout={18000} text={'cat contact.txt'} output={' rolandmathesondev@gmail.com https://www.linkedin.com/in/rolandmatheson/ github.com/rj13371 '} />
